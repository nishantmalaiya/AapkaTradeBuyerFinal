package com.aapkatrade.buyer.uicomponent.bottomnavigationview;
...
/**
 * Created by PPC17 on 26-May-17.
 */

public class CustomBottomNavigationView extends android.support.design.widget.BottomNavigationView {
    ...
    private void init() {
        mShadowDrawable = ContextCompat.getDrawable(getContext(), R.drawable.ms__drop_down_shadow);
