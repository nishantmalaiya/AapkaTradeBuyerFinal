...
public class GpsLocationService extends Service implements LocationListener {
    ...
    public double getLatitude() {
        if (location != null) {
            latitude = location.getLatitude();
            appSharedpreference.setSharedPref(SharedPreferenceConstants.CURRENT_LATTITUDE.toString(), String.valueOf(latitude));
        }
    ...
    public double getLongitude() {
        if (location != null) {
            ...
            appSharedpreference.setSharedPref(SharedPreferenceConstants.CURRENT_LONGITUDE.toString(), String.valueOf(longitude));
        }
    ...
    public String getStaeName() {
        ...
        if (location != null) {
            ...
            geoCoderAddressAsync = new GeoCoderAddress(mContext,location.getLatitude(), location.getLongitude());
