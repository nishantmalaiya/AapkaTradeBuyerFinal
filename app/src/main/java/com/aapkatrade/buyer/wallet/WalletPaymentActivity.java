...
/**
 * Created by PPC16 on 8/25/2017.
 */

public class WalletPaymentActivity extends Activity {

    private ArrayList<String> post_val = new ArrayList<String>();
    private String post_Data = "";
    WebView webView;
    final Activity activity = this;
    private String tag = "WalletPaymentActivity";
...
//    String salt="ZhraT96O"; // live
  ...
  //  String order_number;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressBarHandler = new ProgressBarHandler(WalletPaymentActivity.this);
       ...
       // order_number = oIntent.getExtras().getString("ORDER_NUMBER");
        ...
        webView.setWebViewClient(new WalletPaymentActivity.MyWebViewClient() {
			...
			public boolean shouldOverrideUrlLoading(WebView view, String url) {
				...
				if(url.startsWith(SUCCESS_URL)){
					...
					.makeText(activity, "Payment Successful! " + url, Toast.LENGTH_SHORT).show();
					 Intent intent = new Intent(WalletPaymentActivity.this, MainActivity.class);
        ...
        webView.addJavascriptInterface(new WalletPaymentActivity.PayUJavaScriptInterface(), "PayUMoney");
        Map<String, String> mapParams = new HashMap<String, String>();
        mapParams.put("key", merchant_key);
        mapParams.put("hash", WalletPaymentActivity.this.hash);
        mapParams.put("txnid", (empty(WalletPaymentActivity.this.params.get("txnid"))) ? "" : WalletPaymentActivity.this.params.get("txnid"));
        Log.d(tag, "txnid: " + WalletPaymentActivity.this.params.get("txnid"));
        mapParams.put("service_provider", "payu_paisa");

        mapParams.put("amount", (empty(WalletPaymentActivity.this.params.get("amount"))) ? "" : WalletPaymentActivity.this.params.get("amount"));
        mapParams.put("firstname", (empty(WalletPaymentActivity.this.params.get("firstname"))) ? "" : WalletPaymentActivity.this.params.get("firstname"));
        mapParams.put("email", (empty(WalletPaymentActivity.this.params.get("email"))) ? "" : WalletPaymentActivity.this.params.get("email"));
        mapParams.put("phone", (empty(WalletPaymentActivity.this.params.get("phone"))) ? "" : WalletPaymentActivity.this.params.get("phone"));

        mapParams.put("productinfo", (empty(WalletPaymentActivity.this.params.get("productinfo"))) ? "" : WalletPaymentActivity.this.params.get("productinfo"));
        mapParams.put("surl", (empty(WalletPaymentActivity.this.params.get("surl"))) ? "" : WalletPaymentActivity.this.params.get("surl"));
        mapParams.put("furl", (empty(WalletPaymentActivity.this.params.get("furl"))) ? "" : WalletPaymentActivity.this.params.get("furl"));
        mapParams.put("lastname", (empty(WalletPaymentActivity.this.params.get("lastname"))) ? "" : WalletPaymentActivity.this.params.get("lastname"));

        mapParams.put("address1", (empty(WalletPaymentActivity.this.params.get("address1"))) ? "" : WalletPaymentActivity.this.params.get("address1"));
        mapParams.put("address2", (empty(WalletPaymentActivity.this.params.get("address2"))) ? "" : WalletPaymentActivity.this.params.get("address2"));
        mapParams.put("city", (empty(WalletPaymentActivity.this.params.get("city"))) ? "" : WalletPaymentActivity.this.params.get("city"));
        mapParams.put("state", (empty(WalletPaymentActivity.this.params.get("state"))) ? "" : WalletPaymentActivity.this.params.get("state"));

        mapParams.put("country", (empty(WalletPaymentActivity.this.params.get("country"))) ? "" : WalletPaymentActivity.this.params.get("country"));
        mapParams.put("zipcode", (empty(WalletPaymentActivity.this.params.get("zipcode"))) ? "" : WalletPaymentActivity.this.params.get("zipcode"));
        mapParams.put("udf1", (empty(WalletPaymentActivity.this.params.get("udf1"))) ? "" : WalletPaymentActivity.this.params.get("udf1"));
        mapParams.put("udf2", (empty(WalletPaymentActivity.this.params.get("udf2"))) ? "" : WalletPaymentActivity.this.params.get("udf2"));

        mapParams.put("udf3", (empty(WalletPaymentActivity.this.params.get("udf3"))) ? "" : WalletPaymentActivity.this.params.get("udf3"));
        mapParams.put("udf4", (empty(WalletPaymentActivity.this.params.get("udf4"))) ? "" : WalletPaymentActivity.this.params.get("udf4"));
        mapParams.put("udf5", (empty(WalletPaymentActivity.this.params.get("udf5"))) ? "" : WalletPaymentActivity.this.params.get("udf5"));
        mapParams.put("pg", (empty(WalletPaymentActivity.this.params.get("pg"))) ? "" : WalletPaymentActivity.this.params.get("pg"));
        ...
        public void success(long id, final String paymentId) {
            mHandler.post(new Runnable() {
                public void run() {
                    ...
                    callWebServiceMakePayment(paymentId, "1");

                    /*Intent intent=new Intent(WalletPaymentActivity.this,CartCheckoutActivity.class);
    ...
    /*class PostRechargeData extends AsyncTask<String, String, String>
    {
        ...
        {
            super.onPreExecute();
            pDialog = new ProgressDialog(WalletPaymentActivity.this);
        ...
        protected String doInBackground(String... args)
        {
            ...
            ProfileSessionManager ProSessionManager = new ProfileSessionManager(WalletPaymentActivity.this);
    ...
    private void callWebServiceMakePayment(String transactionId, String status) {
        ...
        String login_url = getApplicationContext().getResources().getString(R.string.webservice_base_url) + "/add_wallet_money";

        System.out.println("order_number--------------"  + status + transactionId + "fgdfgb----");

        Ion.with(WalletPaymentActivity.this)
                .load(login_url)
                ...
                .setBodyParameter("txn_type", "2")
                .setBodyParameter("message","Amt Added")
                .setBodyParameter("trans_amt",getRechargeAmt)
                .setBodyParameter("transactionId", transactionId)
                .setBodyParameter("transaction_status", status)
                .asJsonObject()
